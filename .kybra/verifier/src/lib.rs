...
async fn async_result_handler_call(
    ...
    let call_result_instance = match &cross_canister_call_function_name[..] {
        "call_VerifierCanister_get_verifier" => {
            ...
            create_call_result_instance(
                vm,
                call_VerifierCanister_get_verifier(canister_id_principal, (_cdk_user_defined_id,))
                    .await,
            )?
        }
        "call_VerifierCanister_delete_user" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            let _cdk_user_defined_id: (candid::Principal) =
                args[2usize].clone().try_from_vm_value(vm)?;
            create_call_result_instance(
                vm,
                call_VerifierCanister_delete_user(canister_id_principal, (_cdk_user_defined_id,))
                    .await,
            )?
        }
        "call_VerifierCanister_create_verifier" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            let _cdk_user_defined_website: (String) = args[2usize].clone().try_from_vm_value(vm)?;
            create_call_result_instance(
                vm,
                call_VerifierCanister_create_verifier(
                    canister_id_principal,
                    (_cdk_user_defined_website,),
                )
                .await,
            )?
        }
...
async fn async_result_handler_call_with_payment(
    ...
    let call_result_instance = match &cross_canister_call_with_payment_function_name[..] {
        "call_with_payment_VerifierCanister_get_verifier" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            let _cdk_user_defined_id: (candid::Principal) =
                args[2usize].clone().try_from_vm_value(vm)?;
        ...
        "call_with_payment_VerifierCanister_delete_user" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            let _cdk_user_defined_id: (candid::Principal) =
                args[2usize].clone().try_from_vm_value(vm)?;
        ...
        "call_with_payment_VerifierCanister_create_verifier" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            let _cdk_user_defined_website: (String) = args[2usize].clone().try_from_vm_value(vm)?;
            let payment: u64 = args[3usize].clone().try_from_vm_value(vm)?;
...
async fn async_result_handler_call_with_payment128(
    ...
    let call_result_instance = match &cross_canister_call_with_payment128_function_name[..] {
        "call_with_payment128_VerifierCanister_get_verifier" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            let _cdk_user_defined_id: (candid::Principal) =
                args[2usize].clone().try_from_vm_value(vm)?;
        ...
        "call_with_payment128_VerifierCanister_delete_user" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            let _cdk_user_defined_id: (candid::Principal) =
                args[2usize].clone().try_from_vm_value(vm)?;
        ...
        "call_with_payment128_VerifierCanister_create_verifier" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            let _cdk_user_defined_website: (String) = args[2usize].clone().try_from_vm_value(vm)?;
            let payment: u128 = args[3usize].clone().try_from_vm_value(vm)?;
...
impl Ic {
    ...
    #[pymethod]
    fn notify_VerifierCanister_get_verifier_wrapper(
        &self,
        ...
        let notify_result =
            notify_VerifierCanister_get_verifier(canister_id_principal, (_cdk_user_defined_id,));
        notify_result
            .try_into_vm_value(vm)
            .map_err(|vmc_err| vm.new_type_error(vmc_err.0))
    }
    #[pymethod]
    fn notify_VerifierCanister_delete_user_wrapper(
        &self,
        args_py_object_refs: Vec<rustpython_vm::PyObjectRef>,
        vm: &rustpython_vm::VirtualMachine,
    ) -> rustpython_vm::PyResult {
        ...
        let _cdk_user_defined_id: (candid::Principal) =
            args_py_object_refs[2usize].clone().try_from_vm_value(vm)?;
        let notify_result =
            notify_VerifierCanister_delete_user(canister_id_principal, (_cdk_user_defined_id,));
        notify_result
            .try_into_vm_value(vm)
            .map_err(|vmc_err| vm.new_type_error(vmc_err.0))
    }
    #[pymethod]
    fn notify_VerifierCanister_create_verifier_wrapper(
        &self,
        args_py_object_refs: Vec<rustpython_vm::PyObjectRef>,
        vm: &rustpython_vm::VirtualMachine,
    ) -> rustpython_vm::PyResult {
        let canister_id_principal: ic_cdk::export::Principal =
            args_py_object_refs[0].clone().try_from_vm_value(vm)?;
        let _cdk_user_defined_website: (String) =
            args_py_object_refs[2usize].clone().try_from_vm_value(vm)?;
        let notify_result = notify_VerifierCanister_create_verifier(
            canister_id_principal,
            (_cdk_user_defined_website,),
        );
        notify_result
    ...
    #[pymethod]
    fn notify_with_payment128_VerifierCanister_get_verifier_wrapper(
        &self,
        args_py_object_refs: Vec<rustpython_vm::PyObjectRef>,
        vm: &rustpython_vm::VirtualMachine,
    ) -> rustpython_vm::PyResult {
        ...
        let cycles: u128 = args_py_object_refs[args_py_object_refs.len() - 1]
            .clone()
            .try_from_vm_value(vm)?;
        let notify_result = notify_with_payment128_VerifierCanister_get_verifier(
            canister_id_principal,
            (_cdk_user_defined_id,),
            cycles,
        );
    ...
    #[pymethod]
    fn notify_with_payment128_VerifierCanister_delete_user_wrapper(
        &self,
        args_py_object_refs: Vec<rustpython_vm::PyObjectRef>,
        vm: &rustpython_vm::VirtualMachine,
    ) -> rustpython_vm::PyResult {
        ...
        let cycles: u128 = args_py_object_refs[args_py_object_refs.len() - 1]
            .clone()
            .try_from_vm_value(vm)?;
        let notify_result = notify_with_payment128_VerifierCanister_delete_user(
            canister_id_principal,
            (_cdk_user_defined_id,),
            cycles,
        );
    ...
    #[pymethod]
    fn notify_with_payment128_VerifierCanister_create_verifier_wrapper(
        &self,
        args_py_object_refs: Vec<rustpython_vm::PyObjectRef>,
        vm: &rustpython_vm::VirtualMachine,
    ) -> rustpython_vm::PyResult {
        ...
        let cycles: u128 = args_py_object_refs[args_py_object_refs.len() - 1]
            .clone()
            .try_from_vm_value(vm)?;
        let notify_result = notify_with_payment128_VerifierCanister_create_verifier(
            canister_id_principal,
            (_cdk_user_defined_website,),
            cycles,
        );
...
struct StableBTreeMap4KeyType((candid::Principal));
impl CdkActTryIntoVmValue<&rustpython::vm::VirtualMachine, rustpython::vm::PyObjectRef>
...
struct StableBTreeMap4ValueType((Verifier));
impl CdkActTryIntoVmValue<&rustpython::vm::VirtualMachine, rustpython::vm::PyObjectRef>
...
#[ic_cdk_macros::query(name = "get_verifier")]
#[candid::candid_method(query, rename = "get_verifier")]
async fn _cdk_user_defined_get_verifier(
    ...
    call_global_python_function("get_verifier", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::update(name = "create_verifier")]
#[candid::candid_method(update, rename = "create_verifier")]
async fn _cdk_user_defined_create_verifier(_cdk_user_defined_website: String) -> (Verifier) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    let vm = &interpreter.vm;
    let params = (_cdk_user_defined_website
        .try_into_vm_value(vm)
        .unwrap_or_trap(),);
    call_global_python_function("create_verifier", params)
        .await
        .unwrap_or_trap()
}
...
candid :: define_service ! (VerifierCanister : { "get_verifier" : candid :: func ! ((candid :: Principal) -> (Option < Verifier >) query) ; "delete_user" : candid :: func ! ((candid :: Principal) -> (GetVerifierResult)) ; "create_verifier" : candid :: func ! ((String) -> (Verifier)) });
impl std::cmp::Ord for VerifierCanister {
    fn cmp(&self, other: &Self) -> std::cmp::Ordering {
        self.partial_cmp(other).unwrap_or(std::cmp::Ordering::Equal)
    }
}
impl std::cmp::PartialOrd for VerifierCanister {
    fn partial_cmp(&self, other: &Self) -> Option<std::cmp::Ordering> {
        None
    }
}
impl CdkActTryIntoVmValue<&rustpython::vm::VirtualMachine, rustpython::vm::PyObjectRef>
    for VerifierCanister
{
    fn try_into_vm_value(
        self,
        vm: &rustpython::vm::VirtualMachine,
    ...
    > for rustpython::vm::PyObjectRef
{
    fn try_from_vm_value(
        self,
        vm: &rustpython::vm::VirtualMachine,
    ) -> Result<VerifierCanister, rustpython_vm::builtins::PyBaseExceptionRef> {
        let canister_id = self.get_attr("canister_id", vm)?;
        let to_str = canister_id.get_attr("to_str", vm)?;
        let result = to_str.call((), vm)?;
        let result_string: String = result.try_into_value(vm)?;
        match ic_cdk::export::Principal::from_text(result_string) {
            Ok(principal) => Ok(VerifierCanister::new(principal)),
            Err(err) => Err(vm.new_type_error(format!(
    ...
    > for rustpython::vm::PyObjectRef
{
    fn try_from_vm_value(
        self,
        vm: &rustpython::vm::VirtualMachine,
    ) -> Result<Vec<VerifierCanister>, rustpython_vm::builtins::PyBaseExceptionRef> {
        try_from_vm_value_generic_array(self, vm)
    }
}
#[allow(non_snake_case)]
async fn call_VerifierCanister_get_verifier(
    canister_id_principal: candid::Principal,
    params: (candid::Principal,),
) -> ic_cdk::api::call::CallResult<(Option<Verifier>,)> {
    ic_cdk::api::call::call(canister_id_principal, "get_verifier", params).await
}
#[allow(non_snake_case)]
async fn call_with_payment_VerifierCanister_get_verifier(
    canister_id_principal: candid::Principal,
    params: (candid::Principal,),
    cycles: u64,
) -> ic_cdk::api::call::CallResult<(Option<Verifier>,)> {
    ic_cdk::api::call::call_with_payment(canister_id_principal, "get_verifier", params, cycles)
        .await
}
#[allow(non_snake_case)]
async fn call_with_payment128_VerifierCanister_get_verifier(
    canister_id_principal: candid::Principal,
    params: (candid::Principal,),
    cycles: u128,
) -> ic_cdk::api::call::CallResult<(Option<Verifier>,)> {
    ic_cdk::api::call::call_with_payment128(canister_id_principal, "get_verifier", params, cycles)
        .await
}
#[allow(non_snake_case)]
fn notify_VerifierCanister_get_verifier(
    canister_id_principal: candid::Principal,
    params: (candid::Principal,),
) -> Result<(), ic_cdk::api::call::RejectionCode> {
    ic_cdk::api::call::notify(canister_id_principal, "get_verifier", params)
}
#[allow(non_snake_case)]
fn notify_with_payment128_VerifierCanister_get_verifier(
    canister_id_principal: candid::Principal,
    params: (candid::Principal,),
    cycles: u128,
) -> Result<(), ic_cdk::api::call::RejectionCode> {
    ic_cdk::api::call::notify_with_payment128(canister_id_principal, "get_verifier", params, cycles)
}
#[allow(non_snake_case)]
async fn call_VerifierCanister_delete_user(
    canister_id_principal: candid::Principal,
    params: (candid::Principal,),
) -> ic_cdk::api::call::CallResult<(GetVerifierResult,)> {
    ic_cdk::api::call::call(canister_id_principal, "delete_user", params).await
}
#[allow(non_snake_case)]
async fn call_with_payment_VerifierCanister_delete_user(
    canister_id_principal: candid::Principal,
    params: (candid::Principal,),
    cycles: u64,
) -> ic_cdk::api::call::CallResult<(GetVerifierResult,)> {
    ic_cdk::api::call::call_with_payment(canister_id_principal, "delete_user", params, cycles).await
}
#[allow(non_snake_case)]
async fn call_with_payment128_VerifierCanister_delete_user(
    canister_id_principal: candid::Principal,
    params: (candid::Principal,),
    cycles: u128,
) -> ic_cdk::api::call::CallResult<(GetVerifierResult,)> {
    ic_cdk::api::call::call_with_payment128(canister_id_principal, "delete_user", params, cycles)
        .await
}
#[allow(non_snake_case)]
fn notify_VerifierCanister_delete_user(
    canister_id_principal: candid::Principal,
    params: (candid::Principal,),
) -> Result<(), ic_cdk::api::call::RejectionCode> {
    ic_cdk::api::call::notify(canister_id_principal, "delete_user", params)
}
#[allow(non_snake_case)]
fn notify_with_payment128_VerifierCanister_delete_user(
    canister_id_principal: candid::Principal,
    params: (candid::Principal,),
    cycles: u128,
) -> Result<(), ic_cdk::api::call::RejectionCode> {
    ic_cdk::api::call::notify_with_payment128(canister_id_principal, "delete_user", params, cycles)
}
#[allow(non_snake_case)]
async fn call_VerifierCanister_create_verifier(
    canister_id_principal: candid::Principal,
    params: (String,),
) -> ic_cdk::api::call::CallResult<(Verifier,)> {
    ic_cdk::api::call::call(canister_id_principal, "create_verifier", params).await
}
#[allow(non_snake_case)]
async fn call_with_payment_VerifierCanister_create_verifier(
    canister_id_principal: candid::Principal,
    params: (String,),
    cycles: u64,
) -> ic_cdk::api::call::CallResult<(Verifier,)> {
    ic_cdk::api::call::call_with_payment(canister_id_principal, "create_verifier", params, cycles)
        .await
}
#[allow(non_snake_case)]
async fn call_with_payment128_VerifierCanister_create_verifier(
    canister_id_principal: candid::Principal,
    params: (String,),
    cycles: u128,
) -> ic_cdk::api::call::CallResult<(Verifier,)> {
...
#[allow(non_snake_case)]
fn notify_VerifierCanister_create_verifier(
    canister_id_principal: candid::Principal,
    params: (String,),
) -> Result<(), ic_cdk::api::call::RejectionCode> {
    ic_cdk::api::call::notify(canister_id_principal, "create_verifier", params)
}
#[allow(non_snake_case)]
fn notify_with_payment128_VerifierCanister_create_verifier(
    canister_id_principal: candid::Principal,
    params: (String,),
    cycles: u128,
) -> Result<(), ic_cdk::api::call::RejectionCode> {
...
enum GetVerifierErr {
    VerifierDoesNotExist(candid::Principal),
}
#[derive(
    serde :: Deserialize,
    Debug,
