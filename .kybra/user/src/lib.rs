...
async fn async_result_handler_call(
    ...
    let call_result_instance = match &cross_canister_call_function_name[..] {
        "call_UserCanister_create_user" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            let _cdk_user_defined_birthdate: (u64) = args[2usize].clone().try_from_vm_value(vm)?;
            create_call_result_instance(
                vm,
                call_UserCanister_create_user(
                    canister_id_principal,
                    (_cdk_user_defined_birthdate,),
                )
                .await,
            )?
        }
        "call_UserCanister_get_user" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            let _cdk_user_defined_identity: (candid::Principal) =
                args[2usize].clone().try_from_vm_value(vm)?;
            create_call_result_instance(
                vm,
                call_UserCanister_get_user(canister_id_principal, (_cdk_user_defined_identity,))
                    .await,
            )?
        }
        "call_UserCanister_get_users" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            create_call_result_instance(
                vm,
                call_UserCanister_get_users(canister_id_principal, ()).await,
            )?
        }
        "call_UserCanister_get_age" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            let _cdk_user_defined_id: (candid::Principal) =
                args[2usize].clone().try_from_vm_value(vm)?;
            create_call_result_instance(
                vm,
                call_UserCanister_get_age(canister_id_principal, (_cdk_user_defined_id,)).await,
            )?
        }
        "call_UserCanister_test_time" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            create_call_result_instance(
                vm,
                call_UserCanister_test_time(canister_id_principal, ()).await,
            )?
        }
        _ => {
...
async fn async_result_handler_call_with_payment(
    ...
    let call_result_instance = match &cross_canister_call_with_payment_function_name[..] {
        "call_with_payment_UserCanister_create_user" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            let _cdk_user_defined_birthdate: (u64) = args[2usize].clone().try_from_vm_value(vm)?;
        ...
        "call_with_payment_UserCanister_get_user" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            let _cdk_user_defined_identity: (candid::Principal) =
                args[2usize].clone().try_from_vm_value(vm)?;
            ...
            create_call_result_instance(
                ...
                call_with_payment_UserCanister_get_user(
                    canister_id_principal,
                    (_cdk_user_defined_identity,),
                    payment,
                )
                .await,
            )?
        }
        "call_with_payment_UserCanister_get_users" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            let payment: u64 = args[2usize].clone().try_from_vm_value(vm)?;
            create_call_result_instance(
                vm,
                call_with_payment_UserCanister_get_users(canister_id_principal, (), payment).await,
            )?
        }
        "call_with_payment_UserCanister_get_age" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            let _cdk_user_defined_id: (candid::Principal) =
                args[2usize].clone().try_from_vm_value(vm)?;
        ...
        "call_with_payment_UserCanister_test_time" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            let payment: u64 = args[2usize].clone().try_from_vm_value(vm)?;
            create_call_result_instance(
                vm,
                call_with_payment_UserCanister_test_time(canister_id_principal, (), payment).await,
            )?
        }
        _ => {
            return Err(vm.new_attribute_error(format!(
...
async fn async_result_handler_call_with_payment128(
    ...
    let call_result_instance = match &cross_canister_call_with_payment128_function_name[..] {
        "call_with_payment128_UserCanister_create_user" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            let _cdk_user_defined_birthdate: (u64) = args[2usize].clone().try_from_vm_value(vm)?;
        ...
        "call_with_payment128_UserCanister_get_user" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            let _cdk_user_defined_identity: (candid::Principal) =
                args[2usize].clone().try_from_vm_value(vm)?;
        ...
        "call_with_payment128_UserCanister_get_users" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            let payment: u128 = args[2usize].clone().try_from_vm_value(vm)?;
            create_call_result_instance(
                vm,
                call_with_payment128_UserCanister_get_users(canister_id_principal, (), payment)
                    .await,
            )?
        }
        "call_with_payment128_UserCanister_get_age" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            let _cdk_user_defined_id: (candid::Principal) =
                args[2usize].clone().try_from_vm_value(vm)?;
        ...
        "call_with_payment128_UserCanister_test_time" => {
            let canister_id_principal: ic_cdk::export::Principal =
                args[0].clone().try_from_vm_value(vm)?;
            let payment: u128 = args[2usize].clone().try_from_vm_value(vm)?;
            create_call_result_instance(
                vm,
                call_with_payment128_UserCanister_test_time(canister_id_principal, (), payment)
                    .await,
            )?
        }
        _ => {
...
impl Ic {
    ...
    #[pymethod]
    fn notify_UserCanister_create_user_wrapper(
        &self,
        ...
        let _cdk_user_defined_birthdate: (u64) =
            args_py_object_refs[2usize].clone().try_from_vm_value(vm)?;
        let notify_result =
            notify_UserCanister_create_user(canister_id_principal, (_cdk_user_defined_birthdate,));
        notify_result
            .try_into_vm_value(vm)
            .map_err(|vmc_err| vm.new_type_error(vmc_err.0))
    }
    #[pymethod]
    fn notify_UserCanister_get_user_wrapper(
        &self,
        args_py_object_refs: Vec<rustpython_vm::PyObjectRef>,
        vm: &rustpython_vm::VirtualMachine,
    ) -> rustpython_vm::PyResult {
        ...
        let _cdk_user_defined_identity: (candid::Principal) =
            args_py_object_refs[2usize].clone().try_from_vm_value(vm)?;
        let notify_result =
            notify_UserCanister_get_user(canister_id_principal, (_cdk_user_defined_identity,));
        notify_result
            .try_into_vm_value(vm)
            .map_err(|vmc_err| vm.new_type_error(vmc_err.0))
    }
    #[pymethod]
    fn notify_UserCanister_get_users_wrapper(
        &self,
        args_py_object_refs: Vec<rustpython_vm::PyObjectRef>,
        vm: &rustpython_vm::VirtualMachine,
    ) -> rustpython_vm::PyResult {
        let canister_id_principal: ic_cdk::export::Principal =
            args_py_object_refs[0].clone().try_from_vm_value(vm)?;
        let notify_result = notify_UserCanister_get_users(canister_id_principal, ());
        notify_result
            .try_into_vm_value(vm)
            .map_err(|vmc_err| vm.new_type_error(vmc_err.0))
    }
    #[pymethod]
    fn notify_UserCanister_get_age_wrapper(
        &self,
        args_py_object_refs: Vec<rustpython_vm::PyObjectRef>,
        vm: &rustpython_vm::VirtualMachine,
    ) -> rustpython_vm::PyResult {
        ...
        let _cdk_user_defined_id: (candid::Principal) =
            args_py_object_refs[2usize].clone().try_from_vm_value(vm)?;
        let notify_result =
            notify_UserCanister_get_age(canister_id_principal, (_cdk_user_defined_id,));
        notify_result
            .try_into_vm_value(vm)
            .map_err(|vmc_err| vm.new_type_error(vmc_err.0))
    }
    #[pymethod]
    fn notify_UserCanister_test_time_wrapper(
        &self,
        args_py_object_refs: Vec<rustpython_vm::PyObjectRef>,
        vm: &rustpython_vm::VirtualMachine,
    ) -> rustpython_vm::PyResult {
        let canister_id_principal: ic_cdk::export::Principal =
            args_py_object_refs[0].clone().try_from_vm_value(vm)?;
        let notify_result = notify_UserCanister_test_time(canister_id_principal, ());
        notify_result
            .try_into_vm_value(vm)
            .map_err(|vmc_err| vm.new_type_error(vmc_err.0))
    }
    ...
    #[pymethod]
    fn notify_with_payment128_UserCanister_create_user_wrapper(
        &self,
        args_py_object_refs: Vec<rustpython_vm::PyObjectRef>,
        vm: &rustpython_vm::VirtualMachine,
    ) -> rustpython_vm::PyResult {
        ...
        let cycles: u128 = args_py_object_refs[args_py_object_refs.len() - 1]
            .clone()
            .try_from_vm_value(vm)?;
        let notify_result = notify_with_payment128_UserCanister_create_user(
            canister_id_principal,
            (_cdk_user_defined_birthdate,),
            cycles,
        );
    ...
    #[pymethod]
    fn notify_with_payment128_UserCanister_get_user_wrapper(
        &self,
        args_py_object_refs: Vec<rustpython_vm::PyObjectRef>,
        vm: &rustpython_vm::VirtualMachine,
    ) -> rustpython_vm::PyResult {
        ...
        let cycles: u128 = args_py_object_refs[args_py_object_refs.len() - 1]
            .clone()
            .try_from_vm_value(vm)?;
        let notify_result = notify_with_payment128_UserCanister_get_user(
            canister_id_principal,
            (_cdk_user_defined_identity,),
            cycles,
        );
    ...
    #[pymethod]
    fn notify_with_payment128_UserCanister_get_users_wrapper(
        &self,
        args_py_object_refs: Vec<rustpython_vm::PyObjectRef>,
        vm: &rustpython_vm::VirtualMachine,
    ) -> rustpython_vm::PyResult {
        ...
        let cycles: u128 = args_py_object_refs[args_py_object_refs.len() - 1]
            ...
            .try_from_vm_value(vm)?;
        let notify_result =
            notify_with_payment128_UserCanister_get_users(canister_id_principal, (), cycles);
        notify_result
            .try_into_vm_value(vm)
            .map_err(|vmc_err| vm.new_type_error(vmc_err.0))
    }
    #[pymethod]
    fn notify_with_payment128_UserCanister_get_age_wrapper(
        &self,
        args_py_object_refs: Vec<rustpython_vm::PyObjectRef>,
        vm: &rustpython_vm::VirtualMachine,
    ) -> rustpython_vm::PyResult {
        ...
        let cycles: u128 = args_py_object_refs[args_py_object_refs.len() - 1]
            .clone()
            .try_from_vm_value(vm)?;
        let notify_result = notify_with_payment128_UserCanister_get_age(
            canister_id_principal,
            (_cdk_user_defined_id,),
            cycles,
        );
    ...
    #[pymethod]
    fn notify_with_payment128_UserCanister_test_time_wrapper(
        &self,
        args_py_object_refs: Vec<rustpython_vm::PyObjectRef>,
        vm: &rustpython_vm::VirtualMachine,
    ) -> rustpython_vm::PyResult {
        ...
        let cycles: u128 = args_py_object_refs[args_py_object_refs.len() - 1]
            ...
            .try_from_vm_value(vm)?;
        let notify_result =
            notify_with_payment128_UserCanister_test_time(canister_id_principal, (), cycles);
        notify_result
            .try_into_vm_value(vm)
            .map_err(|vmc_err| vm.new_type_error(vmc_err.0))
    }
...
async fn _cdk_user_defined_get_user(
    _cdk_user_defined_identity: candid::Principal,
) -> (Option<User>) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    let vm = &interpreter.vm;
    let params = (_cdk_user_defined_identity
        .try_into_vm_value(vm)
        .unwrap_or_trap(),);
...
#[ic_cdk_macros::query(name = "get_age")]
#[candid::candid_method(query, rename = "get_age")]
async fn _cdk_user_defined_get_age(_cdk_user_defined_id: candid::Principal) -> (GetUserAgeResult) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    let vm = &interpreter.vm;
    let params = (_cdk_user_defined_id.try_into_vm_value(vm).unwrap_or_trap(),);
    call_global_python_function("get_age", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::query(name = "test_time")]
#[candid::candid_method(query, rename = "test_time")]
async fn _cdk_user_defined_test_time() -> (u64) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    let vm = &interpreter.vm;
    let params = ();
    call_global_python_function("test_time", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::update(name = "create_user")]
#[candid::candid_method(update, rename = "create_user")]
async fn _cdk_user_defined_create_user(_cdk_user_defined_birthdate: u64) -> (User) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    let vm = &interpreter.vm;
    let params = (_cdk_user_defined_birthdate
        .try_into_vm_value(vm)
        .unwrap_or_trap(),);
...
candid :: define_service ! (UserCanister : { "create_user" : candid :: func ! ((u64) -> (candid :: Principal)) ; "get_user" : candid :: func ! ((candid :: Principal) -> (Option < User >) query) ; "get_users" : candid :: func ! (() -> (Vec < User >) query) ; "get_age" : candid :: func ! ((candid :: Principal) -> (GetUserAgeResult) query) ; "test_time" : candid :: func ! (() -> (u64) query) });
impl std::cmp::Ord for UserCanister {
    fn cmp(&self, other: &Self) -> std::cmp::Ordering {
        self.partial_cmp(other).unwrap_or(std::cmp::Ordering::Equal)
    }
}
impl std::cmp::PartialOrd for UserCanister {
    ...
    > for rustpython::vm::PyObjectRef
{
    fn try_from_vm_value(
        self,
        vm: &rustpython::vm::VirtualMachine,
    ) -> Result<UserCanister, rustpython_vm::builtins::PyBaseExceptionRef> {
        let canister_id = self.get_attr("canister_id", vm)?;
        let to_str = canister_id.get_attr("to_str", vm)?;
        let result = to_str.call((), vm)?;
        let result_string: String = result.try_into_value(vm)?;
        match ic_cdk::export::Principal::from_text(result_string) {
            Ok(principal) => Ok(UserCanister::new(principal)),
            Err(err) => Err(vm.new_type_error(format!(
    ...
    > for rustpython::vm::PyObjectRef
{
    fn try_from_vm_value(
        self,
        vm: &rustpython::vm::VirtualMachine,
    ) -> Result<Vec<UserCanister>, rustpython_vm::builtins::PyBaseExceptionRef> {
        try_from_vm_value_generic_array(self, vm)
    }
}
#[allow(non_snake_case)]
async fn call_UserCanister_create_user(
    canister_id_principal: candid::Principal,
    params: (u64,),
) -> ic_cdk::api::call::CallResult<(candid::Principal,)> {
    ic_cdk::api::call::call(canister_id_principal, "create_user", params).await
}
#[allow(non_snake_case)]
async fn call_with_payment_UserCanister_create_user(
    canister_id_principal: candid::Principal,
    params: (u64,),
    cycles: u64,
) -> ic_cdk::api::call::CallResult<(candid::Principal,)> {
    ic_cdk::api::call::call_with_payment(canister_id_principal, "create_user", params, cycles).await
}
#[allow(non_snake_case)]
async fn call_with_payment128_UserCanister_create_user(
    canister_id_principal: candid::Principal,
    params: (u64,),
    cycles: u128,
) -> ic_cdk::api::call::CallResult<(candid::Principal,)> {
    ic_cdk::api::call::call_with_payment128(canister_id_principal, "create_user", params, cycles)
        .await
}
#[allow(non_snake_case)]
fn notify_UserCanister_create_user(
    canister_id_principal: candid::Principal,
    params: (u64,),
) -> Result<(), ic_cdk::api::call::RejectionCode> {
    ic_cdk::api::call::notify(canister_id_principal, "create_user", params)
}
#[allow(non_snake_case)]
fn notify_with_payment128_UserCanister_create_user(
    canister_id_principal: candid::Principal,
    params: (u64,),
    cycles: u128,
) -> Result<(), ic_cdk::api::call::RejectionCode> {
    ic_cdk::api::call::notify_with_payment128(canister_id_principal, "create_user", params, cycles)
}
#[allow(non_snake_case)]
async fn call_UserCanister_get_user(
    canister_id_principal: candid::Principal,
    params: (candid::Principal,),
) -> ic_cdk::api::call::CallResult<(Option<User>,)> {
    ic_cdk::api::call::call(canister_id_principal, "get_user", params).await
}
#[allow(non_snake_case)]
async fn call_with_payment_UserCanister_get_user(
    canister_id_principal: candid::Principal,
    params: (candid::Principal,),
    cycles: u64,
) -> ic_cdk::api::call::CallResult<(Option<User>,)> {
    ic_cdk::api::call::call_with_payment(canister_id_principal, "get_user", params, cycles).await
}
#[allow(non_snake_case)]
async fn call_with_payment128_UserCanister_get_user(
    canister_id_principal: candid::Principal,
    params: (candid::Principal,),
    cycles: u128,
) -> ic_cdk::api::call::CallResult<(Option<User>,)> {
    ic_cdk::api::call::call_with_payment128(canister_id_principal, "get_user", params, cycles).await
}
#[allow(non_snake_case)]
fn notify_UserCanister_get_user(
    canister_id_principal: candid::Principal,
    params: (candid::Principal,),
) -> Result<(), ic_cdk::api::call::RejectionCode> {
    ic_cdk::api::call::notify(canister_id_principal, "get_user", params)
}
#[allow(non_snake_case)]
fn notify_with_payment128_UserCanister_get_user(
    canister_id_principal: candid::Principal,
    params: (candid::Principal,),
    cycles: u128,
) -> Result<(), ic_cdk::api::call::RejectionCode> {
    ic_cdk::api::call::notify_with_payment128(canister_id_principal, "get_user", params, cycles)
}
#[allow(non_snake_case)]
async fn call_UserCanister_get_users(
    canister_id_principal: candid::Principal,
    params: (),
) -> ic_cdk::api::call::CallResult<(Vec<User>,)> {
    ic_cdk::api::call::call(canister_id_principal, "get_users", params).await
}
#[allow(non_snake_case)]
async fn call_with_payment_UserCanister_get_users(
    canister_id_principal: candid::Principal,
    params: (),
    cycles: u64,
) -> ic_cdk::api::call::CallResult<(Vec<User>,)> {
    ic_cdk::api::call::call_with_payment(canister_id_principal, "get_users", params, cycles).await
}
#[allow(non_snake_case)]
async fn call_with_payment128_UserCanister_get_users(
    canister_id_principal: candid::Principal,
    params: (),
    cycles: u128,
) -> ic_cdk::api::call::CallResult<(Vec<User>,)> {
    ic_cdk::api::call::call_with_payment128(canister_id_principal, "get_users", params, cycles)
        .await
}
#[allow(non_snake_case)]
fn notify_UserCanister_get_users(
    canister_id_principal: candid::Principal,
    params: (),
) -> Result<(), ic_cdk::api::call::RejectionCode> {
    ic_cdk::api::call::notify(canister_id_principal, "get_users", params)
}
#[allow(non_snake_case)]
fn notify_with_payment128_UserCanister_get_users(
    canister_id_principal: candid::Principal,
    params: (),
    cycles: u128,
) -> Result<(), ic_cdk::api::call::RejectionCode> {
    ic_cdk::api::call::notify_with_payment128(canister_id_principal, "get_users", params, cycles)
}
#[allow(non_snake_case)]
async fn call_UserCanister_get_age(
    canister_id_principal: candid::Principal,
    params: (candid::Principal,),
) -> ic_cdk::api::call::CallResult<(GetUserAgeResult,)> {
    ic_cdk::api::call::call(canister_id_principal, "get_age", params).await
}
#[allow(non_snake_case)]
async fn call_with_payment_UserCanister_get_age(
    canister_id_principal: candid::Principal,
    params: (candid::Principal,),
    cycles: u64,
) -> ic_cdk::api::call::CallResult<(GetUserAgeResult,)> {
    ic_cdk::api::call::call_with_payment(canister_id_principal, "get_age", params, cycles).await
}
#[allow(non_snake_case)]
async fn call_with_payment128_UserCanister_get_age(
    canister_id_principal: candid::Principal,
    params: (candid::Principal,),
    cycles: u128,
) -> ic_cdk::api::call::CallResult<(GetUserAgeResult,)> {
    ic_cdk::api::call::call_with_payment128(canister_id_principal, "get_age", params, cycles).await
}
#[allow(non_snake_case)]
fn notify_UserCanister_get_age(
    canister_id_principal: candid::Principal,
    params: (candid::Principal,),
) -> Result<(), ic_cdk::api::call::RejectionCode> {
    ic_cdk::api::call::notify(canister_id_principal, "get_age", params)
}
#[allow(non_snake_case)]
fn notify_with_payment128_UserCanister_get_age(
    canister_id_principal: candid::Principal,
    params: (candid::Principal,),
    cycles: u128,
) -> Result<(), ic_cdk::api::call::RejectionCode> {
    ic_cdk::api::call::notify_with_payment128(canister_id_principal, "get_age", params, cycles)
}
#[allow(non_snake_case)]
async fn call_UserCanister_test_time(
    canister_id_principal: candid::Principal,
    params: (),
) -> ic_cdk::api::call::CallResult<(u64,)> {
    ic_cdk::api::call::call(canister_id_principal, "test_time", params).await
}
#[allow(non_snake_case)]
async fn call_with_payment_UserCanister_test_time(
    canister_id_principal: candid::Principal,
    params: (),
    cycles: u64,
) -> ic_cdk::api::call::CallResult<(u64,)> {
    ic_cdk::api::call::call_with_payment(canister_id_principal, "test_time", params, cycles).await
}
#[allow(non_snake_case)]
async fn call_with_payment128_UserCanister_test_time(
    canister_id_principal: candid::Principal,
    params: (),
    cycles: u128,
) -> ic_cdk::api::call::CallResult<(u64,)> {
    ic_cdk::api::call::call_with_payment128(canister_id_principal, "test_time", params, cycles)
        .await
}
#[allow(non_snake_case)]
fn notify_UserCanister_test_time(
    canister_id_principal: candid::Principal,
    params: (),
) -> Result<(), ic_cdk::api::call::RejectionCode> {
    ic_cdk::api::call::notify(canister_id_principal, "test_time", params)
}
#[allow(non_snake_case)]
fn notify_with_payment128_UserCanister_test_time(
    canister_id_principal: candid::Principal,
    params: (),
    cycles: u128,
) -> Result<(), ic_cdk::api::call::RejectionCode> {
    ic_cdk::api::call::notify_with_payment128(canister_id_principal, "test_time", params, cycles)
}
type TimerId = (u64);
type Duration = (u64);
#[derive(
